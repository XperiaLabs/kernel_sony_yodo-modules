...
ifeq ($(AKS_JS_DLKM_ENABLE),  true)
	...
	PRODUCT_COPY_FILES += vendor/qcom/opensource/ecosw/aks_js_drivers/Vendor_2212_Product_0010.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/Vendor_2212_Product_0010.kl
endif
